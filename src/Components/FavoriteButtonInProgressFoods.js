...
const FavoriteButtonInProgressFoods = () => {
  // const [isFavoriteBtn, setIsFavoriteBtn] = useState(false);
  const { recipeInProgress, isFavoriteBtn, setIsFavoriteBtn } = useContext(myContext);
  const detailRecipeInfoGlobal = recipeInProgress[0];
...
export default FavoriteButtonInProgressFoods;
